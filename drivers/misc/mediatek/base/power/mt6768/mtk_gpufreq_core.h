 ...
 **************************************************/
#define SEG_GPU_DVFS_FREQ0			(1120000)	/* KHz */
...
#define gpufreq_pr_warn(fmt, args...)		pr_debug(GPUFERQ_TAG"[WARNING]"fmt, ##args)
#define gpufreq_pr_info(fmt, args...)		pr_debug(GPUFERQ_TAG"[INFO]"fmt, ##args)
